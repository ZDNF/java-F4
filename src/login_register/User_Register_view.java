 ...
 * @author  __USER__
 */
public class User_Register_view extends javax.swing.JFrame {

	/** Creates new form User_Register_view */
	...
	private void initComponents() {
		...
		jLabel2.setBackground(new java.awt.Color(41, 45, 51));
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)
		...
		/*if (this.jRadioButton1.isSelected()) {
			if (User.register(this.jTextField1.getText(), this.jTextField2
		...
		if (this.jRadioButton1.isSelected()) {
			if (!this.jTextField1.getText().equals("")
				...
				Client c = new Client();
				Object[][] usermessage = c.usermessage();
				int pd = 1;
				for (int j = 0; j < usermessage.length; j++) {
					if (this.jTextField1.getText().equals(usermessage[j][1])) {
						pd = 0;
					}
				}
				if (pd == 1) {
					Client c1 = new Client();
					User u = c1.user_register(this.jTextField1.getText(),
							this.jTextField2.getText(), this.jTextField3
									.getText());
					if (u != null) {
						Client c2 = new Client();
						c2.person(u.getId(), u.getUsername(), u.getUemail(),
								"", "中国", "0", "广东省", "广州市");
						Client c3 = new Client();
						c3.buyperson(u.getId(), u.getUsername(), "", "");
						Client c4 = new Client();
						c4.collection(u.getId(), u.getUsername(), "");
						JOptionPane.showMessageDialog(this, "注册成功！");
						this.dispose();
				...
				JOptionPane.showMessageDialog(this, "账号名称、常用邮箱、登录密码为必填！");
			}
		} else {
			JOptionPane.showMessageDialog(this, "请勾选用户隐私权利协议！");
		}
	}
